...
public class ApplicantManagementEmailTemplate {
	...
	public static String onIncomplete(Profile profile) {
		...
		message.append("Thank you for applying for Citizenship by Descent. Your application <code>"+profile.getCustId()+"</code> has been reviewed, however your application is deemed incomplete. Please review the reason below:");
	...
	public static String onCompleted(Profile profile) {
		...
		message.append(profile.getAddress1()+","+profile.getAddress2()+"<br/><br/>");
		message.append("Dear Mr./Ms "+profile.getLastname()+","+"<br/><br/>");
		message.append("Thank you for successfully uploading your application for Jamaican Citizenship by descent. Your application number "+profile.getAppCode()+" has been reviewed. Please proceed to select an appointment date from the list of available dates.");
		message.append("<br/>Please click the link below to schedule your appointment.<br/>");
		
		String schedulingUrl = new ApplicantManagementEmailTemplate().emailLink + "/";
